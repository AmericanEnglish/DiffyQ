...
plot(x0, euler_variance, x0, improved_euler_variance, x0, taylor_variance, x0, Runge_Kutta_variance)
legend('toggle')
legend('Eulers', 'Improved Eulers', 'Taylor Series Differentials', 'Runge-Kutta','location','bestoutside')
xlabel('X')
